...
默认遵循 [docs/PROJECT-STATE.zh-CN.md](docs/PROJECT-STATE.zh-CN.md) 里 `Current Next Action` 的单一下一步；如果 [docs/LATEST-HANDOFF.zh-CN.md](docs/LATEST-HANDOFF.zh-CN.md) 记录了某个未完成任务的更具体恢复点，则以 handoff 为准。
